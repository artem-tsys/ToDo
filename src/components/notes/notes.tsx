...
function Notes(props: Props): JSX.Element {
    ...
    return <div className={style.table}>
        <div className={cn(style.tableHead, styleForm.note)}>
            <div className={cn(styleForm.formField, styleForm.formFieldName)}>Name</div>
            <div className={cn(styleForm.formField, styleForm.formFieldPhone)}>Phone</div>
            <div className={cn(styleForm.formField, styleForm.formButtons)}>Action</div>
        </div>
        {list}
    </div>
}
